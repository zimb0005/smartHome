    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(item.getItemId()){
            case R.id.livingRoom:
                ...
                break;
            case R.id.auto:
                Intent intent2 = new Intent (Kitchen.this,Automobile.class);
                startActivity(intent2);
                break;
            case R.id.houseSettings:
                Intent intent3 = new Intent (Kitchen.this,HouseSettings.class);
                startActivity(intent3);
                break;
            case R.id.kitchen:
                Intent intent4 = new Intent (Kitchen.this,Kitchen.class);
